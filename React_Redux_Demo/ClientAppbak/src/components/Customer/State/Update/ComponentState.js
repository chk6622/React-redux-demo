...
class ButtonState extends BaseState {
    ...
    init() {
        console.log(this.co);
        let customer=this.com.props.customer;
        this.com.setState({ id: customer.id, name: customer.name, address: customer.address, loading: false, isOpen: true, stateObj: new EditDataState(this.com) });
