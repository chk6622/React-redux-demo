...
export const updateStoreQueryParameterAction=(value:any):IAction=>{
    //debugger;
    const action = {
        type:STORE_UPDATE_QUERY_PARAMETER,
        value:value
    }
    return action;
}
...
function getUrl(pageIndex:any=1,nameQry:string,addressQry:string):string{
    ...
    let url:string = `${apiUrl}/api/stores`;
    url = getPaginatedUrl(url,pageIndex);
    url = getQueryParamsUrl(url,nameQry,addressQry);
    return url;
}

export const queryStoreAction=(accessToken:any):any=>{
    ...
    return (dispatch:any,getState:any)=>{
        ...
        let nameQry=state.StoreReducer.nameQry;
        let addressQry=state.StoreReducer.addressQry;
        let curPageIndex=state.StoreReducer.curPageIndex;
        debugger
...
export const addStoreAction=(value:any):IAction=>{
    const action = {
        type:STORE_ADD,
        value:value
    }
...
export const updateStoreAction=(value:any):IAction=>{
    const action = {
        type:STORE_UPDATE,
        value:value
    }
...
export const deleteStoreAction=(storeId:string,accessToken:string):any=>{
    return (
